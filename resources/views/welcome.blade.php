...
<head>
    ...
    <link href="{{ Vite::asset('backend/img/logo/logo.png') }}" rel="icon">
    <title>RuangAdmin - Dashboard</title>
    {{-- <link href="{{ asset('backend/vendor/fontawesome-free/css/all.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('backend/vendor/bootstrap/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('backend/css/ruang-admin.min.css') }}" rel="stylesheet"> --}}
    @vite(['resources/css/app.css', 'resources/backend/css/ruang-admin.min.css', 'resources/backend/vendor/bootstrap/css/bootstrap.min.css', 'resources/backend/vendor/fontawesome-free/css/all.min.css'])
</head>
...
<body id="page-top">
    ...
    @vite(['resources/backend/vendor/jquery/jquery.min.js', 'resources/backend/js/demo/chart-area-demo.js', 'resources/backend/vendor/chart.js/Chart.min.js', 'resources/backend/js/ruang-admin.min.js', 'resources/backend/vendor/jquery-easing/jquery.easing.min.js', 'resources/backend/vendor/bootstrap/js/bootstrap.bundle.min.js'])
</body>
